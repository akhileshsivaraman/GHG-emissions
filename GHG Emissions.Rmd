...
Simple model of emissions over the 31-year period
```{r}
ggplot(annual_emissions, aes(Year, Emissions)) +
  geom_point() +
  geom_smooth(colour = "blue", fullrange = TRUE) +
  theme_classic()
```

```{r}
ts_annual_emissions <- ts(annual_emissions$Emissions, frequency = 31)
